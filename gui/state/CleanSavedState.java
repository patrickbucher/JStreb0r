...
public class CleanSavedState extends FileState implements CleanState {

  private StateContext context;

  private String filename;

  public CleanSavedState(StateContext shell, String filename) {
    this.context = shell;
  ...
  public void saveAs(List<WordPair> list) {
    filename = FileHandler.save(context.getShell(), list);
    describe(); // avoid new instance of this state
  }
